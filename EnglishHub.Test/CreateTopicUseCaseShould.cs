...
public class CreateTopicUseCaseShould
{
    ...
    public CreateTopicUseCaseShould()
    {
        ...
        _createTopicStorageSetup = storage.Setup(s =>
            s.CreateTopic(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<string>()));
        _getForumStorageSetup = getForumsStorage.Setup(s => s.GetForums());
    ...
    public async Task ThrowIntentionManagerException_WhenTopicCreatedNotAllowed()
    {
        ...
        await sut.Invoking(t => t.Execute(new CreateTopicCommand(forumId, "forum"))).Should()
    ...
    public async Task ThrowForumNotFoundException_WhenNoMatchingForum()
    {
        ...
        await sut.Invoking(s => s.Execute(new CreateTopicCommand(forumId, "Some title")))
